 ...
 */
    ...
    public static final double kP = 0.00083998; //voltage per velocity
    ...
    public static double shooterAtm20 = 4200;
    public static double shooterAtm17 = 4100;
    public static double shooterAtm14 = 3900;
    ...
    public static double shooterAt5 = 3350;
    public static double shooterAt8 = 3300;
