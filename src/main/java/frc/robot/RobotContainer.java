...
public class RobotContainer {
    ...
    private void setAutoChooserOptions() {
                ...
                new ResetOdometry(new Pose2d(0, 0, new Rotation2d(0)), s_drivetrain).andThen(
                        new ToggleIntake(s_pneumatics).andThen(
                                new ParallelCommandGroup(
                                        ...
                                        new RunMagazine(s_magazine, .6)).withTimeout(2)
                                                        ...
                                                        .andThen(
                                                                new ParallelCommandGroup(
                                                                        ...
                                                                        new SpinShooter(s_shooter,
                                                                                manipulatorController, 1600),
                                                                        new RunMagazine(s_magazine, .6),
                                                                        new RunIntake(s_intake)).withTimeout(2))))));
        _autoChooser.addOption("3 ball high goal right tarmac",
                new ResetOdometry(new Pose2d(7.74, 2.81, Rotation2d.fromDegrees(-110.64)), s_drivetrain).andThen(
                        new ParallelCommandGroup(new AngleArm(.17, s_arm),
                                new SpinShooter(s_shooter, manipulatorController, 3000),
                                new RunMagazine(s_magazine, .6)).withTimeout(1.5).andThen(
                                        new AngleArm(.07, s_arm).andThen(
                                                TrajectoryHelper.createTrajectoryCommand(
                                                        TrajectoryHelper.generateTrajectory(
                                                                new Pose2d(7.74, 2.81, Rotation2d.fromDegrees(-110.64)),
                                                                List.of(new Translation2d(6, 2.46),
                                                                        new Translation2d(4.71, 1.25),
                                                                        new Translation2d(5.92, .64)),
                                                                new Pose2d(7.18, .52, Rotation2d.fromDegrees(-11.31)),
                                                                false, 3, 2, 1, 0, 0, 7))
                                                        .alongWith(
                                                        ...
                                                        .andThen(
                                                                TrajectoryHelper.createTrajectoryCommand(
                                                                        TrajectoryHelper.generateTrajectory(
                                                                                new Pose2d(7.18, .52,
                                                                                        Rotation2d.fromDegrees(-11.31)),
                                                                                List.of(new Translation2d(6.29, 1.45)),
                                                                                new Pose2d(6.83, 2.41,
                                                                                        Rotation2d.fromDegrees(40.87)),
                                                                                true, 3, 1, 1, 0, 0, 7))
                                                                        .andThen(new ToggleIntake(s_pneumatics).andThen(
                                                                                new LimelightAim(s_drivetrain, s_vision)
                                                                                        .andThen(
                                                                                                new RunMagazine(
                                                                                                        s_magazine, -.6)
                                                                                                                .withTimeout(
        ...
        _autoChooser.addOption("3 ball high goal left tarmac",
                new ResetOdometry(new Pose2d(6.96, 4.54, Rotation2d.fromDegrees(159.1)), s_drivetrain).andThen(
                        new ParallelCommandGroup(new AngleArm(.17, s_arm),
                                new SpinShooter(s_shooter, manipulatorController, 3000),
                                new RunMagazine(s_magazine, .6)).withTimeout(.75).andThen(
                                        new AngleArm(.07, s_arm).andThen(
                                                TrajectoryHelper.createTrajectoryCommand(
                                                        TrajectoryHelper.generateTrajectory(
                                                                new Pose2d(6.96, 4.54, Rotation2d.fromDegrees(159.1)),
                                                                List.of(new Translation2d(3.72, 4.13)),
                                                                new Pose2d(1.66, 1.60, Rotation2d.fromDegrees(-135.34)),
                                                                false, 3, 2, 1, 0, 0, 7))
                                                        .alongWith(
                                                                new RunIntake(s_intake)
                                                                        .alongWith(new RunMagazine(s_magazine, .3)))
                                                        .andThen(
                                                                TrajectoryHelper.createTrajectoryCommand(
                                                                        TrajectoryHelper.generateTrajectory(
                                                                                new Pose2d(1.66, 1.60,
                                                                                        Rotation2d
                                                                                                .fromDegrees(-135.34)),
                                                                                List.of(new Translation2d(3.69, 4.01)),
                                                                                new Pose2d(6.96, 4.54,
                                                                                        Rotation2d.fromDegrees(159.1)),
                                                                                true, 2, 1, 1, 0, 0, 7))
                                                                        .alongWith(new RunIntake(s_intake).alongWith(
                                                                                new RunMagazine(s_magazine, .3)))
                                                                        .andThen(
                                                                                new RunMagazine(s_magazine, -.6)
    ...
    private void configureButtonBindings() {
        ...
        leftBumperM.whileHeld(new RunMagazine(s_magazine, .6));
